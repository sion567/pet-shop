package com.example.pet.shop.common.base.web;
...
public class Servlets {
    ...
    public static String getFileDownloadName(HttpServletRequest request, String fileName)
        ...
        boolean isMS = (agent != null &&
                (agent.toUpperCase().indexOf("MSIE") != -1
                        || agent.toUpperCase().indexOf("EDGE") != -1
                        || agent.toUpperCase().indexOf("TRIDENT") != -1 ));
        if (isMS) {
            encodedfileName = URLEncoder.encode(fileName, DEFAULT_URL_ENCODING);
        } else {
            encodedfileName = new String(fileName.getBytes(DEFAULT_URL_ENCODING), Charsets.ISO_8859_1);
        }
    ...
    public static void setFileDownloadHeader(HttpServletRequest request, HttpServletResponse response, String fileName)
        ...
        response.setHeader(HttpHeaders.CONTENT_DISPOSITION,
                "attachment; filename=\"" + getFileDownloadName(request, fileName) + "\"");
    }
    ...
    public static String encodeHttpBasic(String userName, String password) {
        ...
        return "Basic " + BaseEncoding.base64().encode(encode.getBytes());
    }
